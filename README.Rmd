...
Note that the above installation code worked on my Windows (10.0.19041 x86) 
machine but, on my linux machine (Ubuntu 20.04), The package would only install
...
If you can't get the vignette to build, you can access it online here: 
https://morrowcj.github.io/remotePARTS/Alaska.html. 

### Windows installation notes/troubleshooting:

On my Windows 10 PC, I had to change the permission settings for R
