...
List crosspart_worker_cpp(const MapMatd& xxi, const MapMatd& xxj, const MapMatd& xxi0, const MapMatd& xxj0, const MapMatd& tUinv_i, const MapMatd& tUinv_j, double nug_i, double nug_j, const MapMatd& Vij, int df1, int df2);
RcppExport SEXP _remoteSTAR_crosspart_worker_cpp(SEXP xxiSEXP, SEXP xxjSEXP, SEXP xxi0SEXP, SEXP xxj0SEXP, SEXP tUinv_iSEXP, SEXP tUinv_jSEXP, SEXP nug_iSEXP, SEXP nug_jSEXP, SEXP VijSEXP, SEXP df1SEXP, SEXP df2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const MapMatd& >::type Vij(VijSEXP);
    Rcpp::traits::input_parameter< int >::type df1(df1SEXP);
    Rcpp::traits::input_parameter< int >::type df2(df2SEXP);
    rcpp_result_gen = Rcpp::wrap(crosspart_worker_cpp(xxi, xxj, xxi0, xxj0, tUinv_i, tUinv_j, nug_i, nug_j, Vij, df1, df2));
    return rcpp_result_gen;
END_RCPP
}
