...
estimating the time trends in NDVI for each pixel, represented by $\beta_1$ 
in the regression model

$$ y(t) = \beta_0 + \beta_1 t + \varepsilon(t)$$

where the random errors $\varepsilon(t)$ follow an AR(1) process: 

$$\varepsilon(t) = b\varepsilon(t - 1) + \delta(t)$
