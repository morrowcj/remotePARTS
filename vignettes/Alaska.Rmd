...
$$Y(t) = \alpha X(t) + \varepsilon(t)$$ where

* $Y(t)$ is a response variable of interest at time $t$,

* $\alpha$ is a vector of effects of the predictor variables $X(t)$ on $Y(t)$,

* $\varepsilon(t)$ is an temporal autoregressive process: $\varepsilon(t) = \rho_i (\varepsilon(t - i)) + \delta(t)$,
