...
Now, we will use Generalized LS regression to test whether there is a 
...
The function that performs this analysis is the wrapper `fitGLS.partition`. What
...
(t.test = cor_t(coef = coef.means, part.SEs = part.SEs, 
                                   rcoef = rcoef.mean, 
...
n1 = fitNugget(mod.mat, V, rel.est) # old from remotePARTS
