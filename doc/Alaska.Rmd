...
We are interested in asking the following questions using these data: "Is NDVI in Alaska 
...
(`logLik` = `r round(GLS.opt$logLik, digits = 3)`) compared to the intercept-only model 
(`logLik` = `r round(GLS.opt$logLik0, digits = 3)`).
