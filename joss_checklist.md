...
* [x] software is OSI open source

* [x] hosted where user can open issues and approve changes (GitHub)

* [x] software has an **obvious** research application (remote sensing, spatiotemporal statistics, computational 
efficiency)
...
* [x] stored in a repository that can be cloned without registration (GitHub / CRAN)

* [x] stored in a repository that is browsable online without registration

* [x] Have an issue tracker that people can use to create tickets
