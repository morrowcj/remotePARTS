############################################################################
# AR.reml performs AR(1) REML on a model with covariates u
############################################################################
...
############################################################################
# simX simulates a collection of correlated time series
############################################################################
...
############################################################################
# LS.fit fits a LS model using lm() to a matrix of time series located in each row
############################################################################
...
############################################################################
# taper.spherical and taper.spherical.dif are different formulations for tapered distance matrices in which cell more distant than beta are set to zero.
############################################################################
...
############################################################################
# spatialcor.fit fits an exponential or taper-spherical distance matrix to a spatial set of time series by performing CLS, calculating the correlation matrix of residuals, and then fitting the correlations using nls.
############################################################################
...
############################################################################
# correlated.F.bootstrap gives the multiple-comparisons-corrected p-values and also performs a bootstrap to get the distribution of a correlated F test. It might be possible to work this out algebraically.
############################################################################
